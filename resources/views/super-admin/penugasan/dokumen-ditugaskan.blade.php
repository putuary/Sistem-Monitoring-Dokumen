                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="js-flatpickr form-control" name="tenggat_waktu" data-enable-time="true" data-time_24hr="true" />
          ...
          <table class="table table-bordered table-striped table-vcenter js-dataTable-responsive">
            <thead>
              <tr>
                ...
                <th class="text-center"  style="width: 15%;">Dikumpulkan</th>
                @if (request('tahun_ajaran') ? (request('tahun_ajaran') == $tahun_aktif->id_tahun_ajaran ? true :false) : true)
                    ...
                    <div class="block-content fs-sm mb-3">
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="form-group">
                            <label for="example-text-input">Tenggat Waktu</label>
                            <input type="text" class="js-flatpickr form-control" name="tenggat_waktu" data-enable-time="true" data-time_24hr="true" id="tenggat_waktu"/>
                            <label class="form-label fw-8">Dikumpul</label>
                            <div class="space-x-2 mb-3">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="dikumpul1" name="dikumpul" value=0>
                                <label class="form-check-label" for="example-radios-inline1">Single Dokumen</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" id="dikumpul2" name="dikumpul" value=1>
                                <label class="form-check-label" for="example-radios-inline2">Multiple Dokumen</label>
                              </div>
                            </div>
                          </div>
...
@section('script')
    ...
    <script>
      ...
      function editDokumen(id) {
        ...
        if(jsfiles[id].dikumpul === 0){
          $('#dikumpul1').attr('checked', 'checked');
        }else if(jsfiles[id].dikumpul === 1){
          $('#dikumpul2').attr('checked', 'checked');
        }
      }
