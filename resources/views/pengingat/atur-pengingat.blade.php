                ...
                <td class="text-center">
                  <div class="d-flex">
                      <div class="form-check form-switch align-items-center">
                        <input class="form-check-input" type="checkbox" value="{{ $item->pengumpulan }}" id="example-switch-default1" name="example-switch-default1" @if($item->pengumpulan == 1) checked @endif>
                      </div>
                  </div>
                </td>
                <td class="text-center">
