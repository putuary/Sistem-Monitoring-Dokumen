...
!(function (n) {
    ...
    function Qt(n) {
        ...
        if (n.scrollBarVis !== L && n.scrollBarVis !== N)
            return (n.scrollBarVis = L), void O(n);
        (n.scrollBarVis = L),
            y.children("thead, tfoot").remove(),
            C &&
                ((L = C.clone().prependTo(y)),
                (R = C.find("tr")),
                (a = L.find("tr")),
                L.find("[id]").removeAttr("id")),
            (L = v.clone().prependTo(y)),
            (v = v.find("tr")),
            (e = L.find("tr")),
            ...
            "" === l
                ? ((_.width = "100%"),
                  T &&
                      (y.find("tbody").height() > p.offsetHeight ||
                          "scroll" == g.css("overflow-y")) &&
                      (_.width = k(y.outerWidth() - i)),
                  (c = y.outerWidth()))
                : "" !== s && ((_.width = k(s)), (c = y.outerWidth())),
            M(t, e),
            M(function (t) {
            ...
            C &&
                (M(t, a),
                M(function (t) {
                    F.push(t.innerHTML), A.push(k(P(t).css("width")));
                }, a),
                M(function (t, e) {
                    t.style.width = A[e];
                }, R),
            ...
            Math.round(y.outerWidth()) < Math.round(c)
                ? ((o =
            ...
            (b.width = k(o)),
            (f.width = k(o)),
            C && (n.nScrollFoot.style.width = k(o)),
            u || (T && (b.height = k(D.offsetHeight + i)));
        var L = y.outerWidth(),
            v =
                ((d[0].style.width = k(L)),
                (h.width = k(L)),
                y.height() > p.clientHeight || "scroll" == g.css("overflow-y")),
            R = "padding" + (w.bScrollbarLeft ? "Left" : "Right");
        (h[R] = v ? i + "px" : "0px"),
            C &&
                ((S[0].style.width = k(L)),
                (m[0].style.width = k(L)),
                (m[0].style[R] = v ? i + "px" : "0px")),
