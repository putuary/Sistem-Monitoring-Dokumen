        ...
        (function () {
            ...
            function Z(e) {
                ...
                if (p) {
                    var O = V(i),
                        ...
                        T = "clientWidth";
                    O === A(i) &&
                        "static" !== W((O = q(i))).position &&
                        "absolute" === h &&
                        ((j = "scrollHeight"), (T = "scrollWidth")),
                        (l === n || ((l === s || l === o) && c === u)) &&
                            ((S = r),
                            (y -=
                                (m && O === L && L.visualViewport
            ...
            function ge(e, t) {
                ...
                var i = t,
                    ...
                    A = (function (e, t, i) {
                        ...
                        j(L) ? L : L.contextElement || q(e.elements.popper),
                        u,
                        m
                    ),
                        ...
                        if (O) {
                            if (u) {
                                var F,
                                    ...
                                    ne = X(0, A[B], Z[B]),
                                    re = k
                                        ? A[B] / 2 - Y - ne - te - C.mainAxis
                                        : U - ne - te - C.mainAxis,
                                    oe = k
                                        ? -A[B] / 2 + Y + ne + ie + C.mainAxis
                                        : K + ne + ie + C.mainAxis,
                                    se =
                            ...
                            if (h) {
                                var de,
                                    ...
                                    _e = -1 !== [n, s].indexOf(x),
                                    ye =
                                        null != (de = null == D ? void 0 : D[L])
                                            ? de
                                            : 0,
                                    we = _e
                                        ? ve
                                        : pe - A[me] - j[me] - ye + C.altAxis,
                                    xe = _e
                                        ? pe + A[me] + j[me] - ye - C.altAxis
                                        : be,
                                    Ee =
            ...
            const Ce = "transitionend",
                ...
                Re = (e, t, i) => {
                    Object.keys(i).forEach((n) => {
                        ...
                        if (!new RegExp(r).test(s))
                            throw new TypeError(
                                `${e.toUpperCase()}: Option "${n}" provided type "${s}" but expected type "${r}".`
                            );
                    });
                },
                ze = (e) =>
                ...
                Ue = (e, t, i = !0) => {
                    ...
                    const o = ({ target: i }) => {
                        i === t &&
                            ((r = !0), t.removeEventListener(Ce, o), Ye(e));
                    };
            ...
            class vt extends gt {
                ...
                close() {
                    if (
                        ht.trigger(this._element, "close.bs.alert")
                            .defaultPrevented
                    )
                        return;
            ...
            const xt = {
                    ...
                    getDataAttribute: (e, t) =>
                        yt(e.getAttribute(`data-bs-${wt(t)}`)),
                    offset(e) {
                ...
                Et = {
                    ...
                    focusableChildren(e) {
                        const t = [
                            ...
                            .join(", ");
                        return this.find(t, e).filter((e) => !We(e) && ze(e));
                    },
                },
                kt = "carousel",
                St = {
            ...
            class Nt extends gt {
                ...
                _addTouchEventListeners() {
                    ...
                    Et.find(".carousel-item img", this._element).forEach(
                        (e) => {
                            ht.on(e, "dragstart.bs.carousel", (e) =>
                                e.preventDefault()
                            );
                        }
                    ),
                ...
                _getItemIndex(e) {
                    return (
                        (this._items =
                            e && e.parentNode
                                ? Et.find(".carousel-item", e.parentNode)
                                : []),
            ...
            class Vt extends gt {
                ...
                show() {
                    ...
                    if (t.length) {
                        ...
                        if (
                            ((e = n ? Vt.getInstance(n) : null),
                            e && e._isTransitioning)
                        )
                            return;
                    }
                    if (
                        ht.trigger(this._element, "show.bs.collapse")
                            .defaultPrevented
                    )
                        return;
                    t.forEach((t) => {
                        i !== t &&
                            Vt.getOrCreateInstance(t, { toggle: !1 }).hide(),
                ...
                hide() {
                    if (this._isTransitioning || !this._isShown()) return;
                    if (
                        ht.trigger(this._element, "hide.bs.collapse")
                            .defaultPrevented
                    )
                        return;
            ...
            class di extends gt {
                ...
                show() {
                    ...
                    if (
                        ht.trigger(this._element, "show.bs.dropdown", e)
                            .defaultPrevented
                    )
                        return;
                ...
                _completeHide(e) {
                    ht.trigger(this._element, "hide.bs.dropdown", e)
                        .defaultPrevented ||
                        ("ontouchstart" in document.documentElement &&
                            []
                                .concat(...document.body.children)
                ...
                static dataApiKeydownHandler(e) {
                    ...
                    if ((e.preventDefault(), e.stopPropagation(), We(this)))
                        return;
            ...
            class ki {
                ...
                deactivate() {
                    this._isActive &&
                        ((this._isActive = !1), ht.off(document, xi));
                }
                _handleFocusin(e) {
                    const { target: t } = e,
            ...
            class Ri extends gt {
                ...
                hide() {
                    ...
                    if (
                        ht.trigger(this._element, "hide.bs.modal")
                            .defaultPrevented
                    )
                        return;
                    this._isShown = !1;
                ...
                Ui = (e, t) => {
                    ...
                    if (t.includes(i))
                        return (
                            !Qi.has(i) ||
                            Boolean(
                                Xi.test(e.nodeValue) || Yi.test(e.nodeValue)
                            )
                        );
            ...
            class fn extends gt {
                ...
                _enter(e, t) {
                    (t = this._initializeOnDelegatedTarget(e, t)),
                        e &&
                            (t._activeTrigger["focusin" === e.type ? hn : dn] =
                                !0),
                        t.getTipElement().classList.contains(on) ||
                        t._hoverState === sn
                            ? (t._hoverState = sn)
            ...
            class kn extends gt {
                ...
                dispose() {
                    ht.off(this._scrollElement, ".bs.scrollspy"),
                        super.dispose();
                }
                _getConfig(e) {
                    return (
                ...
                _activate(e) {
                    ...
                    i.classList.add(wn),
                        i.classList.contains("dropdown-item")
                            ...
                            : Et.parents(i, ".nav, .list-group").forEach(
                                  (e) => {
                                      Et.prev(
                                          e,
                                          ".nav-link, .list-group-item"
                                      ).forEach((e) => e.classList.add(wn)),
                                          Et.prev(e, ".nav-item").forEach(
                                              (e) => {
                                                  Et.children(
                                                      e,
                                                      ".nav-link"
            ...
            ht.on(
                ...
                function (e) {
                    ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                        We(this) || Tn.getOrCreateInstance(this).show();
                }
            ),
                Xe(Tn);
            const Cn = "toast",
            ...
            class Fn extends gt {
                ...
                show() {
                    ht.trigger(this._element, "show.bs.toast")
                        .defaultPrevented ||
                        (this._clearTimeout(),
                ...
                hide() {
                    this._element.classList.contains(Pn) &&
                        (ht.trigger(this._element, "hide.bs.toast")
                            .defaultPrevented ||
                            (this._element.classList.add(In),
                            this._queueCallback(
                                () => {
                        ...
                        (e.prototype.observe = function () {
                            var e = this,
                                t = function () {
                                    return (
                                        e.observer &&
                                        e.observer.observe(document.body, br)
                                    );
                                };
                            document.body
                                ? t()
                        ...
                        (t._lSidebar || t._lSideOverlay) &&
                            ("init" === e
                                ...
                                : (e = "custom-scroll") &&
                                  ...
                                  (t._lSidebar &&
                                      !t._lSidebarScroll &&
                                      (t._lSidebarScroll = new Fr(
                                          t._lSidebarScrollCon
                                      )),
                                  t._lSideOverlay &&
                                      !t._lSideOverlayScroll &&
                                      (t._lSideOverlayScroll = new Fr(
                                          t._lSideOverlay
                                      ))));
                    }
                    _uiHandleNav() {
